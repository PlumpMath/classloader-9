...
public final class URIClassLoader extends URLClassLoader {
    ...
    public URL findResource(final String name) {
        return AccessController.doPrivileged((PrivilegedAction<URL>) () -> finder.findResource(name), acc);
    }
    ...
    public Enumeration<URL> findResources(final String name) throws IOException {
        return AccessController.doPrivileged((PrivilegedAction<Enumeration<URL>>) () -> finder.findResources(name), acc);
    }
    ...
    private ResourceHandle getResourceHandle(final String name) {
        return AccessController.doPrivileged((PrivilegedAction<ResourceHandle>) () ->
